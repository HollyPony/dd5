...
import charSheetAuthorityProperties from '../../modules/stores/charSheet.authority.properties.js'
    ...
    replaceElement(this.#listElement, this.#props.syncConflicts.map(conflict => {
      ...
      return createElement('div', [
        createElement('div', [
          ...
          createElement('small', t._('modals.syncConflicts.localEntry', { date: localDate, name: conflict.localEntry.data[charSheetAuthorityProperties.name] }), {
            class: 'text-body-secondary d-block',
          }),
          createElement('small', t._('modals.syncConflicts.remoteEntry', { date: remoteDate, name: conflict.remoteEntry.data[charSheetAuthorityProperties.name] }), {
            class: 'text-body-secondary d-block',
          }),
